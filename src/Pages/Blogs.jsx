                        ...
                        <div key={blog.id} className="card bg-white shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 group">
                            ...
                            <figure className="relative h-56 overflow-hidden">
                                ...
                                <div className="absolute top-4 left-4">
                                    <span className="badge badge-error text-white font-bold p-3 uppercase text-[10px] tracking-widest shadow-lg border-none">
                                        {blog.category}
                                    </span>
                                </div>
                            </figure>
            ...
            <div className="max-w-4xl mx-auto px-4 mt-20">
                <div className="bg-red-50 rounded-[2rem] p-8 md:p-12 text-center border-2 border-dashed border-red-200">
                    ...
                    <div className="flex flex-col md:flex-row gap-2 max-w-md mx-auto">
                        <input type="email" placeholder="Enter your email" className="input input-bordered flex-1 rounded-full px-6 focus:outline-red-500" />
                        <button className="btn btn-error rounded-full text-white px-8 font-bold border-none bg-red-600 hover:bg-red-700">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
